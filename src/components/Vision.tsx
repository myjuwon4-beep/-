...
export default function Vision() {
  ...
  return (
    <section id="vision" className="py-24 md:py-28 bg-[#1A1A21] relative border-t border-white/[0.08]">
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch" id="vision-content-grid">
          ...
          <div className="lg:col-span-7 flex flex-col justify-between p-8 sm:p-10 bg-[#202028] border border-white/[0.12] border-t-white/[0.16] rounded-xl">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between p-8 sm:p-10 bg-[#202028] border border-white/[0.12] border-t-white/[0.16] rounded-xl">
            <div>
              ...
              <div className="space-y-4">
                <a
                  href={telUrl}
                  className="flex items-center justify-between p-5 bg-[#1A1A21] border border-white/[0.08] hover:bg-[#2A2A34] hover:border-white/[0.16] rounded-xl transition-all duration-200 group cursor-pointer"
                  title="바로 전화 걸기"
                >
                  <div className="flex items-center space-x-4">
                    <div className="p-3 bg-[#202028] border border-white/[0.08] text-white rounded-lg group-hover:bg-white group-hover:text-black transition-colors">
                      <Phone size={18} />
                    </div>
                    <div>
                      <span className="text-[13px] font-bold text-[#8A8A93] block mb-0.5">휴대폰 번호</span>
