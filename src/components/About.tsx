...
export default function About({ siteTexts = defaultSiteTexts }: AboutProps) {
  const values = [
    ...
    },
    {
      ...
      title: "올인원 책임 프로덕션",
      description: "8년이라는 오랜 기간 동안 몸담았던 회사에서 스튜디오 관리나 직원들의 안전 및 전체 에스코팅 관리까지 전문적으로 수행했기 때문에 팀워크 활동에 능숙합니다. 이에 더하여 전략적 기획안 도출, 1인 촬영 시 고성능 멀티캠(최대 5cam) 동시 제어·운영 노하우, 그리고 정확하고 깔끔한 최종 컷 편집까지 완성도 높은 1인 책임 제작이 가능합니다."
    },
    {
      icon: <Award className="text-primary-red" size={22} />,
      title: "마케팅 지표 성장 증명",
      description: "가장 확실한 포트폴리오는 수치입니다. 케이트레일러 채널의 유튜브 구독자를 전년 대비 1년 만에 2,000명에서 7,200명대(360%↑)로 견인하고, 타겟화된 인스타그램 릴스 고관여 91만 뷰 기획으로 채널 가치를 직접 상승 주도한 입증된 실력을 보유했습니다."
    }
  ];
